...
class CmdSocialLaugh(DefaultCmdSocial):  key = "laugh"
class CmdSocialSigh(DefaultCmdSocial):   key = "sigh"
class CmdSocialPoint(DefaultCmdSocial):  key = "point"
...
class CmdSocialArgh(DefaultCmdSocialFmt):
    ...
    def parse(self):
        ...
        if (self.no_args):
            ...
            self.target_found_room_msg = "%s looks at %s and goes, 'ARRGHHHH!!!', frustratedly." % (
...
class CmdSocialWank(DefaultCmdSocialFmt):
    ...
    def parse(self):
        ...
        if (self.no_args):
            ...
            self.target_found_room_msg = "%s looks at %s longingly, and begins to masturbate." % (
            self.caller, self.target)
