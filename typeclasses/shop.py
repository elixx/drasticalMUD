...
def make_pants(caller):
    pants = [("a pair of black sweats", "Plain, black sweatpants with an elastic waistband and drawstring.", ["sweats","pants"]),
              ("a pair of faded jeans", "These jeans have been bean the hell up. THey are very faded and worn.", ["jeans","pants"]),
...
def make_hazmat(caller):
    name, desc = ("a {Yyellow{n hazmat suit", "A {Yyellow{x hazmat suit{n, such as to protect from hazardous {Gchemicals{n and {Rradiation{n.")
